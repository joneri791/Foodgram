...
(function() {
    'use strict';
    var closestElem = function(elem, LabelName) {
        if (elem.nodeName === LabelName.toUpperCase()) {
            return elem;
        }
        if (elem.parentNode.nodeName === 'BODY') {
            return null;
        }
        return elem.parentNode && closestElem(elem.parentNode, LabelName);
    };

    window.addEventListener('load', function() {
        // Add anchor Label for Show/Hide link
        ...
        // Add toggle to hide/show anchor Label
